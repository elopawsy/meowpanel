...
import QuickCommands from '@/components/server/console/QuickCommands';
        ...
        <ServerContentBlock title={'Home'}>
            <div className='w-full h-full min-h-full flex-1 flex flex-col px-2 sm:px-0'>
                ...
                <div className='flex flex-col gap-3 sm:gap-4'>
                    ...
                    {/* Player List - only shows if playerlisting feature is enabled */}
                    {eggFeatures.map((v) => v.toLowerCase()).includes('playerlisting') && (
                        <div
                            className='transform-gpu skeleton-anim-2'
                            style={{
