...
<?php $__env->startSection('content'); ?>
  ...
  <div class="row">
      ...
      <div class="box box-primary">
        ...
        <table class="table table-hover">
          ...
          <td><code data-attr="info-version"><i class="fa fa-refresh fa-fw fa-spin"></i></code> (Latest:
            <code><?php echo e($version->getDaemon()); ?></code>)
          </td>
          </tr>
          <tr>
    ...
    ?>
        <div class="col-sm-12">
        <div class="info-box bg-<?php echo e($diskColor); ?>" style="background: <?php echo e($diskColor); ?>">
          <span class="info-box-icon"><i class="ion ion-ios-folder-outline"></i></span>
          <div class="info-box-content" style="padding: 15px 10px 0;">
          <span class="info-box-text">Disk Space Allocated</span>
          <span class="info-box-number">
            <?php echo e($allocatedDisk); ?> /
            <?php echo e($totalDisk); ?>
        ...
        <div class="col-sm-12">
        <div class="info-box bg-<?php echo e($memoryColor); ?>" style="background: <?php echo e($memoryColor); ?>">
          <span class=" info-box-icon"><i class="ion ion-ios-barcode-outline"></i></span>
          <div class="info-box-content" style="padding: 15px 10px 0;">
          <span class="info-box-text">Memory Allocated</span>
          <span class="info-box-number">
            <?php echo e(humanizeSize($stats['memory']['value'] * 1024 * 1024)); ?> /
            <?php echo e($totalMemory); ?>

          </span>
          <div class="progress">
            <div class="progress-bar" style="width: <?php echo e($memoryPercent); ?>%"></div>
          </div>
          </div>
        </div>
        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/pyrodactyl/resources/views/admin/nodes/view/index.blade.php ENDPATH**/ ?>