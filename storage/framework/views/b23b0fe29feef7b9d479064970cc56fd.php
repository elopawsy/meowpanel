                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $nodes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $node): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td style="color: <?php echo e($node->memory_color); ?>"><?php echo e($node->memory_percent); ?>%</td>
                                <td><?php echo e($node->allocated_memory); ?></td>
                                <td><?php echo e($node->total_memory); ?></td>
                                <td style="color: <?php echo e($node->disk_color); ?>"><?php echo e($node->disk_percent); ?>%</td>
                                <td><?php echo e($node->allocated_disk); ?></td>
                                <td><?php echo e($node->total_disk); ?></td>
                                <td class="text-center"><?php echo e($node->servers_count); ?></td>
                                <td class="text-center"><?php echo e($node->daemonType); ?></td>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/pyrodactyl/resources/views/admin/nodes/index.blade.php ENDPATH**/ ?>