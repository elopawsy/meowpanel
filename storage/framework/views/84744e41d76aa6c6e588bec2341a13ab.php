...
<?php $__env->startSection('footer-scripts'); ?>
    ...
    $('#configTokenBtn').on('click', function (event) {
        $.ajax({
            ...
            var commandTemplate = "<?php echo addslashes($node->getAutoDeploy("PLACEHOLDER_TOKEN")); ?>";
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/pyrodactyl/resources/views/admin/nodes/view/configuration.blade.php ENDPATH**/ ?>