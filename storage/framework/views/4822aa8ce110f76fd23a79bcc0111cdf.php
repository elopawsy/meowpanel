                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $servers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $server): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr data-server="<?php echo e($server->uuidShort); ?>">
                                ...
                                <td><a href="<?php echo e(route('admin.users.view', $server->user->id)); ?>"><?php echo e($server->user->username); ?> (<?php echo e($server->user->email); ?>)</a></td>
                                ...
                                <!-- <td><?php echo e($server->domain); ?></td> -->
                                <td class="text-center">
                                    ...
                                    <?php if($server->exclude_from_resource_calculation): ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/pyrodactyl/resources/views/admin/servers/index.blade.php ENDPATH**/ ?>