            ...
            <div class="box">
                ...
                <div class="box-body row">
                    <div class="form-group col-xs-6">
                        ...
                        <div>
                            <input type="text" id="pDatabaseLimit" name="database_limit" class="form-control" value="<?php echo e(old('database_limit')); ?>" placeholder="Leave blank for unlimited"/>
                        </div>
                    ...
                    <div class="form-group col-xs-6">
                        ...
                        <div>
                            <input type="text" id="pAllocationLimit" name="allocation_limit" class="form-control" value="<?php echo e(old('allocation_limit')); ?>" placeholder="Leave blank for unlimited"/>
                        </div>
                    ...
                    <div class="form-group col-xs-6">
                        ...
                        <div>
                            <input type="text" id="pBackupLimit" name="backup_limit" class="form-control" value="<?php echo e(old('backup_limit')); ?>" placeholder="Leave blank for unlimited"/>
                        </div>
                    ...
                    <div class="form-group col-xs-6">
                        ...
                        <div class="input-group">
                            <input type="text" id="pBackupStorageLimit" name="backup_storage_limit" data-multiplicator="true" class="form-control" value="<?php echo e(old('backup_storage_limit')); ?>" placeholder="Leave blank for unlimited"/>
            ...
            <div class="box">
                ...
                <div class="box-body row">
                    ...
                    <div class="form-group col-xs-6">
                        ...
                        <div class="input-group">
                            <input type="text" id="pOverheadMemory" name="overhead_memory" class="form-control" value="<?php echo e(old('overhead_memory', 0)); ?>" />
                            <span class="input-group-addon">MiB</span>
                        </div>
                ...
                <div class="box-body row">
                    ...
                    <div class="form-group col-xs-12">
                        <div class="checkbox checkbox-primary no-margin-bottom">
                            <input type="checkbox" id="pExcludeFromResourceCalculation" name="exclude_from_resource_calculation" value="1" <?php echo e(\Pterodactyl\Helpers\Utilities::checked('exclude_from_resource_calculation', 0)); ?> />
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/pyrodactyl/resources/views/admin/servers/new.blade.php ENDPATH**/ ?>