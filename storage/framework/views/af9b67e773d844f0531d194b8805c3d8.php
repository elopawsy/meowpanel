...
<?php $__env->startSection('content-header'); ?>
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="<?php echo e(route('admin.settings.domains.index')); ?>">Domains</a></li>
...
<?php $__env->startSection('content'); ?>
  ...
  <div class="row">
    <div class="col-xs-12">
      <form action="<?php echo e(route('admin.settings.domains.store')); ?>" method="POST" id="domain-form">
        <div class="box">
                ...
                <div>
                  <select name="dns_provider" id="dns_provider" class="form-control" required>
                    ...
                    <?php $__currentLoopData = $providers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $provider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($key); ?>" <?php if(old('dns_provider') === $key): ?> selected <?php endif; ?>>
          ...
          <div class="box-body">
            <div class="row">
              <div class="form-group col-md-6">
                ...
                <div>
                  <div class="btn-group" data-toggle="buttons">
                    <label class="btn btn-outline-primary <?php if(old('is_active', true)): ?> active <?php endif; ?>">
                      <input type="radio" name="is_active" value="1" <?php if(old('is_active', true)): ?> checked <?php endif; ?>> Active
                    </label>
                    <label class="btn btn-outline-primary <?php if(!old('is_active', true)): ?> active <?php endif; ?>">
                      <input type="radio" name="is_active" value="0" <?php if(!old('is_active', true)): ?> checked <?php endif; ?>> Inactive
                    </label>
                  </div>
              ...
              <div class="form-group col-md-6">
                ...
                <div>
                  <div class="btn-group" data-toggle="buttons">
                    <label class="btn btn-outline-primary <?php if(old('is_default', false)): ?> active <?php endif; ?>">
                      <input type="radio" name="is_default" value="1" <?php if(old('is_default', false)): ?> checked <?php endif; ?>> Yes
                    </label>
                    <label class="btn btn-outline-primary <?php if(!old('is_default', false)): ?> active <?php endif; ?>">
                      <input type="radio" name="is_default" value="0" <?php if(!old('is_default', false)): ?> checked <?php endif; ?>> No
                    </label>
                  </div>
        ...
        <div class="box box-primary">
          <div class="box-footer">
            ...
            <a href="<?php echo e(route('admin.settings.domains.index')); ?>" class="btn btn-sm btn-default">Cancel</a>
  ...
  <script>
    $(document).ready(function () {
      ...
      $testButton.click(function () {
        ...
        $.post('<?php echo e(route('admin.settings.domains.test-connection')); ?>', {
      ...
      function loadProviderConfig(provider) {
        $.get(`<?php echo e(route('admin.settings.domains.provider-schema', ':provider')); ?>`.replace(':provider', provider))
          .done(function (response) {
            if (response.success) {
      ...
      function renderConfigForm(schema) {
        ...
        Object.keys(schema).forEach(function (key) {
          ...
          const oldValue = `<?php echo e(old('dns_config.${key}')); ?>`.replace('${key}', key);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/pyrodactyl/resources/views/admin/settings/domains/create.blade.php ENDPATH**/ ?>