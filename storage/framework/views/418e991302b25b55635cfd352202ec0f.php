<?php echo $__env->make('partials/admin.settings.nav', ['activeTab' => 'captcha'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php $__env->startSection('content'); ?>
  ...
  <div class="row">
    <div class="col-xs-12">
      <form action="<?php echo e(route('admin.settings.captcha')); ?>" method="POST">
        <div class="box">
                ...
                <div>
                  <select name="pterodactyl:captcha:provider" class="form-control" id="captcha-provider">
                    <?php $__currentLoopData = $providers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($key); ?>" <?php if(old('pterodactyl:captcha:provider', config('pterodactyl.captcha.provider', 'none')) === $key): ?> selected <?php endif; ?>><?php echo e($name); ?></option>
              ...
              <div class="form-group col-md-6">
                ...
                <div>
                  <input type="text" class="form-control" name="pterodactyl:captcha:turnstile:site_key"
                    value="<?php echo e(old('pterodactyl:captcha:turnstile:site_key', config('pterodactyl.captcha.turnstile.site_key', ''))); ?>" />
              ...
              <div class="form-group col-md-6">
                ...
                <div>
                  <input type="password" class="form-control" name="pterodactyl:captcha:turnstile:secret_key"
                    value="<?php echo e(old('pterodactyl:captcha:turnstile:secret_key', config('pterodactyl.captcha.turnstile.secret_key', ''))); ?>" />
              ...
              <div class="form-group col-md-6">
                ...
                <div>
                  <input type="text" class="form-control" name="pterodactyl:captcha:hcaptcha:site_key"
                    value="<?php echo e(old('pterodactyl:captcha:hcaptcha:site_key', config('pterodactyl.captcha.hcaptcha.site_key', ''))); ?>" />
              ...
              <div class="form-group col-md-6">
                ...
                <div>
                  <input type="password" class="form-control" name="pterodactyl:captcha:hcaptcha:secret_key"
                    value="<?php echo e(old('pterodactyl:captcha:hcaptcha:secret_key', config('pterodactyl.captcha.hcaptcha.secret_key', ''))); ?>" />
              ...
              <div class="form-group col-md-6">
                ...
                <div>
                  <input type="text" class="form-control" name="pterodactyl:captcha:recaptcha:site_key"
                    value="<?php echo e(old('pterodactyl:captcha:recaptcha:site_key', config('pterodactyl.captcha.recaptcha.site_key', ''))); ?>" />
              ...
              <div class="form-group col-md-6">
                ...
                <div>
                  <input type="password" class="form-control" name="pterodactyl:captcha:recaptcha:secret_key"
                    value="<?php echo e(old('pterodactyl:captcha:recaptcha:secret_key', config('pterodactyl.captcha.recaptcha.secret_key', ''))); ?>" />
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/pyrodactyl/resources/views/admin/settings/captcha.blade.php ENDPATH**/ ?>