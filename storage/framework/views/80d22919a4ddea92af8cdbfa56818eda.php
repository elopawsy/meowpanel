<?php echo $__env->make('partials/admin.settings.nav', ['activeTab' => 'mail'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
  ...
  <div class="row">
    ...
    <?php else: ?>
      ...
      <div class="form-group col-md-6">
        ...
        value="<?php echo e(old('mail:mailers:smtp:host', config('mail.mailers.smtp.host'))); ?>" />
      ...
      <div class="form-group col-md-2">
        ...
        value="<?php echo e(old('mail:mailers:smtp:port', config('mail.mailers.smtp.port'))); ?>" />
      ...
      <div class="form-group col-md-6">
        ...
        value="<?php echo e(old('mail:mailers:smtp:username', config('mail.mailers.smtp.username'))); ?>" />
      ...
      <div class="form-group col-md-6">
        ...
        value="<?php echo e(old('mail:from:address', config('mail.from.address'))); ?>" />
      ...
      <div class="form-group col-md-6">
        ...
        value="<?php echo e(old('mail:from:name', config('mail.from.name'))); ?>" />
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/pyrodactyl/resources/views/admin/settings/mail.blade.php ENDPATH**/ ?>