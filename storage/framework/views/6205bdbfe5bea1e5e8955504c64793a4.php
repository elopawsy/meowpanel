    ...
    <div class="col-sm-6">
      ...
      <div class="box-body row">
        ...
        <div>
          ...
          value="<?php echo e(old('name', $node->name)); ?>" />
        ...
        <div>
          ...
          class="form-control"><?php echo e($node->description); ?></textarea>
        </div>
        </div>
        <div class="form-group col-xs-12">
        ...
        <div>
          ...
          <?php $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($location->id); ?>" <?php echo e((old('location_id', $node->location_id) === $location->id) ? 'selected' : ''); ?>><?php echo e($location->long); ?> (<?php echo e($location->short); ?>)</option>
        ...
        <select name="daemonType" id="pDaemonType" class="form-control">
            <?php $__currentLoopData = $daemonTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $daemon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($daemon); ?>" <?php echo e($daemon == old('daemon_type', $node->daemonType) ? 'selected' : ''); ?>><?php echo e($daemon); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
        </div>
        ...
        <div>
          <input type="radio" name="public" value="1" <?php echo e((old('public', $node->public)) ? 'checked' : ''); ?>

          id="public_1" checked> <label for="public_1" style="padding-left:5px;">Yes</label><br />
          <input type="radio" name="public" value="0" <?php echo e((old('public', $node->public)) ? '' : 'checked'); ?>
        ...
        <div>
          <input type="radio" name="trust_alias" value="1" <?php echo e((old('trustalias', $node->trust_alias)) ? 'checked' : ''); ?>

          id="trust_alias_1" checked> <label for="public_1" style="padding-left:5px;">Yes</label><br />
          <input type="radio" name="trust_alias" value="0" <?php echo e((old('trustalias', $node->trust_alias)) ? '' : 'checked'); ?>
        ...
        <div>
          ...
          value="<?php echo e(old('fqdn', $node->fqdn)); ?>" />
        </div>
        <p class="text-muted">
          <small>
          Domain name that browsers will use to connect to <?php echo e($node->daemonType); ?> (e.g <code><?php echo e($node->daemonType); ?>.example.com</code>).
        ...
        <div>
          ...
          value="<?php echo e(old('internal_fqdn', $node->internal_fqdn)); ?>" />
        </div>
        <p class="text-muted">
          <small>
          <strong>Optional:</strong>
          Leave blank to use the Public FQDN for panel-to-<?php echo e($node->daemonType); ?> communication.
          If specified, this internal domain name will be used for panel-to-<?php echo e($node->daemonType); ?> communication instead
          (e.g <code><?php echo e($node->daemonType); ?>-internal.example.com</code> or <code>10.0.0.5</code>).
          Useful for internal networks where the panel needs to communicate with <?php echo e($node->daemonType); ?> using a
        ...
        <div>
          <div class="radio radio-success radio-inline">
          <input type="radio" id="pMaintenanceFalse" value="0" name="maintenance_mode" <?php echo e((old('maintenance_mode', $node->maintenance_mode) == false) ? 'checked' : ''); ?>>
          <label for="pMaintenanceFalse"> Disabled</label>
          </div>
          <div class="radio radio-warning radio-inline">
          <input type="radio" id="pMaintenanceTrue" value="1" name="maintenance_mode" <?php echo e((old('maintenance_mode', $node->maintenance_mode) == true) ? 'checked' : ''); ?>>
      ...
      <div class="box-body row">
        ...
        <div class="row">
          ...
          <div class="input-group">
            ...
            value="<?php echo e(old('memory', $node->memory)); ?>" />
          ...
          <div class="input-group">
            ...
            value="<?php echo e(old('memory_overallocate', $node->memory_overallocate)); ?>" />
        ...
        <div class="row">
          ...
          <div class="input-group">
            ...
            value="<?php echo e(old('disk', $node->disk)); ?>" />
            <span class="input-group-addon">MiB</span>
          </div>
          </div>
          <div class="form-group col-xs-6">
          ...
          <div class="input-group">
            ...
            value="<?php echo e(old('disk_overallocate', $node->disk_overallocate)); ?>" />
            <span class="input-group-addon">%</span>
          </div>
          </div>
        </div>
    ...
    <div class="col-sm-6">
      ...
      <div class="box-body row">
        ...
        <div class="input-group">
          ...
          value="<?php echo e(old('upload_size', $node->upload_size)); ?>" />
          <span class="input-group-addon">MiB</span>
        </div>
        ...
        <div class="row">
          ...
          <div>
            ...
            value="<?php echo e(old('daemonListen', $node->daemonListen)); ?>" />
          </div>
          </div>
          <div class="form-group col-md-6">
          ...
          <div>
            ...
            value="<?php echo e(old('daemonSFTP', $node->daemonSFTP)); ?>" />
          </div>
          </div>
        </div>
        <div class="row">
    ...
    <script>
        $(document).ready(function() {
            ...
            function updateBackupDisks() {
                ...
                const disks = <?php echo json_encode($backupDisks ?? []); ?>[daemonValue] || [];
                ...
                disks.forEach(disk => {
                    ...
                    if (disk === '<?php echo e(old("backupDisk", $node->backupDisk)); ?>') {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/pyrodactyl/resources/views/admin/nodes/view/settings.blade.php ENDPATH**/ ?>