                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if($server->memory === 0): ?>
                                        <code>Unlimited</code>
                                    <?php else: ?>
                                        <code><?php echo e($server->memory); ?>MiB</code>
                                    <?php endif; ?>
                                    /
                                    ...
                                    <?php else: ?>
                                        <code data-toggle="tooltip" data-placement="top" title="Swap Space"> <?php echo e($server->swap); ?>MiB</code>
                                    <?php endif; ?>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <?php if($server->disk === 0): ?>
                                        <code>Unlimited</code>
                                    <?php else: ?>
                                        <code><?php echo e($server->disk); ?>MiB</code>
                                    <?php endif; ?>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <div class="col-sm-12">
                        <div class="small-box bg-zinc">
                            <div class="inner">
                                ...
                                <p><?php echo e($server->user->email); ?></p>
                                <p>Server Owner</p>
                            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/pyrodactyl/resources/views/admin/servers/view/index.blade.php ENDPATH**/ ?>