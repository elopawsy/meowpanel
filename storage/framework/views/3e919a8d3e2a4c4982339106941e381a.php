            ...
            <div class="box">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" name="overhead_memory" data-multiplicator="true" class="form-control" value="<?php echo e(old('overhead_memory', $server->overhead_memory)); ?>"/>
                            <span class="input-group-addon">MiB</span>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <div class="radio radio-success radio-inline">
                                <input type="radio" id="pResourceCalcIncluded" value="0" name="exclude_from_resource_calculation" <?php if(!$server->exclude_from_resource_calculation): ?>checked <?php endif; ?>>
                                <label for="pResourceCalcIncluded">Included</label>
                            </div>
                            <div class="radio radio-warning radio-inline">
                                <input type="radio" id="pResourceCalcExcluded" value="1" name="exclude_from_resource_calculation" <?php if($server->exclude_from_resource_calculation): ?>checked <?php endif; ?>>
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="form-group col-xs-6">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="backup_storage_limit" data-multiplicator="true" class="form-control" value="<?php echo e(old('backup_storage_limit', $server->backup_storage_limit)); ?>"/>
                                        <span class="input-group-addon">MiB</span>
                                    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/pyrodactyl/resources/views/admin/servers/view/build.blade.php ENDPATH**/ ?>